            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h1 className="text-5xl lg:text-7xl font-bold tracking-tight text-slate-900 mb-6 leading-tight">
                  Understand Indian law. <span className="text-slate-500">Draft smarter. Research with sources.</span>
                </h1>
                <p className="text-lg text-slate-600 mb-8 leading-relaxed max-w-lg">
                  LexAI helps founders and teams understand legal issues, ask questions, generate documents, and review legal context with source-backed answers designed for Indian legal workflows.
                </p>
